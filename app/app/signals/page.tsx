...
export default function SignalsPage() {
  ...
  const getStatusIcon = (status: Signal["status"]) => {
    switch (status) {
      ...
      case "hit": return <CheckCircle className="w-4 h-4 text-green-500" />;
      case "stopped": return <X className="w-4 h-4 text-red-500" />;
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-4">
            <Button
              ...
              className={notifications ? "bg-blue-50 border-blue-200" : ""}
            >
              {notifications ? (
            ...
            <Badge variant="secondary" className="bg-gradient-to-r from-yellow-500 to-orange-500">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-3 gap-4 p-4 bg-muted/50 rounded-lg">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-lg font-bold text-green-600">{signal.target}</p>
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-lg font-bold text-red-600">{signal.stoploss}</p>
                ...
                {signal.performance && (
                  <div className="flex items-center justify-between pt-2">
                    ...
                    <div className={`text-sm font-bold ${
                      signal.performance.pnl >= 0 ? 'text-green-600' : 'text-red-600'
                    }`}>
