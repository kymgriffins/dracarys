  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
        ...
        {/* Education Card */}
        <Card className="bg-gradient-to-r from-blue-50 to-violet-50 dark:from-blue-950 dark:to-violet-950 border border-blue-200 dark:border-blue-800 rounded-3xl backdrop-blur-sm">
          <CardContent className="p-8 space-y-6">
            <div className="flex items-start gap-6">
              <div className="p-3 rounded-2xl bg-blue-100/20 dark:bg-blue-900/20">
        ...
        <Card className="rounded-3xl backdrop-blur-sm bg-white/5 border border-white/10 hover:bg-white/10 transition-all duration-300">
          <CardHeader className="p-8">
            <div className="flex items-center justify-between">
              ...
              <Badge className="px-4 py-2 rounded-full bg-green-100 text-green-700 border border-green-200">
                Live Data
              </Badge>
            </div>
          </CardHeader>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Card className="rounded-3xl backdrop-blur-sm bg-white/5 border border-white/10 hover:bg-white/10 transition-all duration-300">
            <CardHeader className="p-8 space-y-6">
              <div className="p-4 rounded-2xl bg-blue-100/20 dark:bg-blue-900/20 w-fit">
          ...
          <Card className="rounded-3xl backdrop-blur-sm bg-white/5 border border-white/10 hover:bg-white/10 transition-all duration-300">
            <CardHeader className="p-8 space-y-6">
              <div className="p-4 rounded-2xl bg-orange-100/20 dark:bg-orange-900/20 w-fit">
          ...
          <Card className="rounded-3xl backdrop-blur-sm bg-white/5 border border-white/10 hover:bg-white/10 transition-all duration-300">
            <CardHeader className="p-8 space-y-6">
              <div className="p-4 rounded-2xl bg-green-100/20 dark:bg-green-900/20 w-fit">
        ...
        {/* Disclaimer */}
        <Card className="bg-yellow-50/80 dark:bg-yellow-950/50 border border-yellow-200 dark:border-yellow-800 rounded-3xl backdrop-blur-sm">
          <CardContent className="p-8 space-y-6">
            <div className="flex items-start gap-6">
              <div className="p-3 rounded-2xl bg-yellow-100/20 dark:bg-yellow-900/20">
