  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Card className="mb-8 border-secondary bg-gradient-to-br from-purple-50 to-blue-50">
          <CardContent className="p-8 text-center">
            ...
            <h3 className="text-lg text-secondary-foreground mb-4">Master Trading Mentor</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="border-secondary bg-secondary/50">
              ...
              <CardContent>
                ...
                <Button className="w-full bg-secondary">Start Premium Trial</Button>
              </CardContent>
            </Card>
            ...
            <Card className="border-secondary bg-secondary/50">
              ...
              <CardContent>
                ...
                <Button className="w-full bg-secondary">Start Mentoring Pro</Button>
              </CardContent>
            </Card>
          </div>
        )}
        ...
        {activeTab === "billing" && (
          <div className="space-y-6">
                      ...
                      <CardContent className="p-6">
                        ...
                        <div className="space-y-2 mb-4">
                          <div className="flex items-center gap-2 text-sm">
                            ...
                            <span className="text-secondary-foreground font-semibold">{method.fees}</span>
                          </div>
            ...
            <Card className="border-secondary bg-gradient-to-r from-purple-50 to-pink-50">
              <CardContent className="p-8 text-center">
                ...
                <div className="flex gap-4 justify-center">
                  ...
                  <Button size="lg" variant="outline" className="border-secondary text-secondary-foreground">
