      ...
      <Card className="bg-gradient-to-r from-blue-50 to-purple-50 border-2">
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="text-center">
              <div className={`text-3xl font-bold ${data.tradingStats!.pnl >= 0 ? 'text-secondary-foreground' : 'text-muted-foreground'}`}>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-3">
            {[
              { value: 10, label: 'Frustrated' as const, emoji: '😞', color: 'bg-muted/10 border-muted text-muted-foreground hover:bg-muted/20' },
              { value: 30, label: 'Annoyed' as const, emoji: '😠', color: 'bg-muted/10 border-muted text-muted-foreground hover:bg-muted/20' },
              { value: 50, label: 'Neutral' as const, emoji: '😐', color: 'bg-primary/10 border-primary text-primary hover:bg-primary/20' },
              { value: 70, label: 'Optimistic' as const, emoji: '😊', color: 'bg-accent/10 border-accent text-accent-foreground hover:bg-accent/20' },
              { value: 90, label: 'Euphoric' as const, emoji: '🎉', color: 'bg-secondary/10 border-secondary text-secondary-foreground hover:bg-secondary/20' },
            ].map((moodOption) => (
              <button
