    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-secondary-foreground">+$1,250.75</div>
      ...
      <div className="space-y-4">
        ...
        {entries.length === 0 ? (
          ...
          <div className="space-y-4">
            {entries.map((entry) => (
              <Link key={entry.id} href={`/jawgnarl/${entry.id}`}>
                  ...
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <div className={`text-lg font-bold ${entry.pnl && entry.pnl >= 0 ? 'text-secondary-foreground' : 'text-muted-foreground'}`}>
