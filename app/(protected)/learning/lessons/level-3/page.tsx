                ...
                <div key={index} className="space-y-4">
                  <div className="flex items-center gap-3">
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center text-lg font-bold
                      ${section.title.includes('Displacement') ? 'bg-muted text-white' :
                        section.title.includes('Retracement') ? 'bg-primary text-white' :
            ...
            <Card className="border-secondary bg-secondary">
              <CardContent className="p-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h4 className="font-semibold text-secondary-foreground">Bullish P3 Setup</h4>
                </div>
            ...
            <Card className="border-muted bg-muted">
              <CardContent className="p-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h4 className="font-semibold text-muted-foreground">Bearish P3 Setup</h4>
                </div>
              ...
              <div className="text-sm text-muted-foreground">
                {selectedAnswers[currentQuestionIndex] !== undefined && (
                  selectedAnswers[currentQuestionIndex] === currentQuestion.correctAnswer ? (
                    <span className="text-secondary-foreground">✓ Correct! Perfect application of P3 philosophy.</span>
                  ) : (
                    <span className="text-muted-foreground">✗ Review the P3 framework and try again.</span>
                  )
                )}
              </div>
              <Button
                ...
                <Card key={question.id} className={
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-start gap-3">
                      {selectedAnswers[index] === question.correctAnswer ? (
                        <CheckCircle className="w-5 h-5 text-secondary-foreground mt-0.5" />
                      ) : (
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-xs space-y-1">
                          <div>
                            ...
                            <span className={selectedAnswers[index] === question.correctAnswer ? 'text-secondary-foreground' : 'text-muted-foreground'}>
                          ...
                          {selectedAnswers[index] !== question.correctAnswer && (
                            <div>
                              ...
                              <span className="text-secondary-foreground">{question.options[question.correctAnswer]}</span>
                            </div>
                          )}
                        </div>
                      </div>
            ...
            <div className="flex gap-4 pt-4">
              {score === lessonData.assessment.questions.length ? (
                <div className="w-full space-y-4">
                  <div className="text-center p-6 bg-gradient-to-r from-purple-50 to-blue-50 border border-secondary rounded-lg">
                    <Target className="w-12 h-12 text-secondary-foreground mx-auto mb-2" />
                    <h3 className="text-lg font-bold text-secondary-foreground mb-1">P3 Sniper Achieved! 🎯</h3>
                  ...
                  <Link href="/learning/gamified" className="w-full">
                ...
                <div className="w-full space-y-4">
                  <div className="text-center p-6 bg-primary border border-primary rounded-lg">
                    <Target className="w-12 h-12 text-primary mx-auto mb-2" />
                    <h3 className="text-lg font-bold text-primary mb-1">Refine Your Sniper Vision 📊</h3>
